...
export default async function CargaTipoPage({
  params,
}: {
  ...
  const titulo = tipo === "diesel" ? "Diésel" : "Bencina";
    ...
    <main className="min-h-dvh px-5 py-8">
      <div className="max-w-md mx-auto">
        <header className="flex items-start justify-between mb-6">
          <div>
            <p className="text-accent text-xs tracking-wider">
              REGISTRO DE FLOTA · {titulo.toUpperCase()}
            </p>
        ...
        <p className="text-center text-xs mb-4">
          <Link href="/carga" className="text-accent">
            &larr; Cambiar tipo de combustible
          </Link>
        </p>
